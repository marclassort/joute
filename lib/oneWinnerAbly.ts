...
import {fetchOneWinnerAblyToken, OneWinnerAuth} from "./oneWinnerApi";
 ...
 */
export function createOneWinnerAblyClient(auth: OneWinnerAuth, gameId: string): Ably.Realtime {
    return new Ably.Realtime({
        authCallback: (_params, callback) => {
            fetchOneWinnerAblyToken(auth, gameId)
